<div class="modal fade text-left" id="editRevenue{{ $row->id }}" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel17">Edit Revenue</h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{ route('update-revenue') }}" method="POST"
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="hours"
                                                        value="{{ $row->hours }}" placeholder="Enter hours"
                                                        required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="amount"
                                                        value="{{ $row->amount }}" placeholder="Enter amount"
                                                        required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control flatpickr-basic"
                                                        value="{{ $row->payment_date }}" name="payment_date"
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Update Revenue</button>
