                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body mt-75 ml-1">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#editProfile"
                                                class="btn btn-sm btn-outline-primary mb-75">Edit Profile Photo</a>
                                    ...
                                    <form action="{{ route('admin-profile-update') }}" method="POST"
                                        class="mt-2">
                                        @csrf
                                        <input type="hidden" name="user_id" value="{{ Auth::user()->company->id }}">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ Auth::user()->company->company_code }}"
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="{{ Auth::user()->company->company_contact }}"
                                                        class="form-control" id="account-e-mail" name="company_contact"
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary mt-2 mr-1">Update
                                                    Profile</button>
                                ...
                                <div class="tab-pane fade" id="account-vertical-password" role="tabpanel"
                                    ...
                                    <!-- form -->
                                    <form action="{{ url('/admin/company/user-password/change-password-store') }}" method="POST">
                                        @csrf
                                          <div class="row">
                                              <div class="col-12 col-sm-6">
                                                  <div class="form-group">
