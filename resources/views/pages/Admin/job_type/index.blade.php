    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#add">Add Job-Type</a>
            </div>
                            ...
                            <td>{{$row->company_code}}</td>
                              ...
                              <td>
                                <a href="#" data-toggle="modal" data-target="#edit{{$row->id}}"><i data-feather='edit'></i></a>
                                  <a href="/job/type/delete/{{$row->id}}"><i data-feather='trash-2'></i></a>
                              </td>
                          </tr>
                          @include('pages.Admin.job_type.modals.EditModal')
                          @endforeach
