<div class="modal fade text-left" id="editStatus{{ $row->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{ route('status.update') }}" method="POST"
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Status Name"
                                                        name="status_name" required value="{{ $row->status_name }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                            ...
                                            {{-- <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="User Id"
                                                        name="user_id" required value="{{ $row->user_id }}" />
                                                </div>
                                            </div> --}}
                                            {{-- <div class="col-md-6 col-12">
                                                <div class="form-group">
